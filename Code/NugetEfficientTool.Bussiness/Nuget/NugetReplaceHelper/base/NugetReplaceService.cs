...
namespace NugetEfficientTool.Business
{
    ...
    public class NugetReplaceService
    {
        ...
        public bool Replace(string solutionFile, string nugetName, string sourceProjectFile)
        {
            ...
            //先获取所有配置文件
            var configFilesInSln = SolutionFileHelper.GetConfigFileInSln(solutionFile, nugetName);
            //替换解决方案文件 - Sln file
        ...
        public bool Revert(string solutionFile, string nugetName, string sourceProjectFile)
        {
            ...
            //恢复项目配置文件
            var configFilesInSln = SolutionFileHelper.GetConfigFileInSln(solutionFile, replacedNugetInfo.Name);
            foreach (var configFile in configFilesInSln)
            {
